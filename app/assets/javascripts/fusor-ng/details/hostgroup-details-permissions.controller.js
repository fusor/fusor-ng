...
/**
 * @ngdoc object
 * @name  FusorNg.fusor-ng.controller:HostgroupDetailsPermissionsController
 *
 * @requires $scope
 * @requires $q
 * @requires gettext
 ...
 */
angular.module('FusorNg.fusor-ng').controller('HostgroupDetailsPermissionsController',
    ['$scope', '$location', '$q', '$filter', 'gettext', 'Nutupane', 'Hostgroup',
    function ($scope, $location, $q, $filter, gettext, Nutupane, Hostgroup) {

        var params = {
            'id':               $scope.$stateParams.hostgroupId,
        };

        var nutupane = new Nutupane(Hostgroup, params, 'permissions');
